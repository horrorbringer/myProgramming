...
int main(){
   ...
   float price;
   float qty;
   double total_payment_USD;
   double total_payment_KHR;
   double total_payment_CNY;
   double total_payment_VND;
   double afterDis_payment_USD;
   double afterDis_payment_KHR;
   double afterDis_payment_CNY;
   double afterDis_payment_VND;
