...
int main(){
    ...
    cout<<"\t\t\t\t\tmenu"<<endl;
    cout<<"\t\t\t\t\t1.COFFEE"<<setw(25)<<"2.SOFT DRINK"<<setw(25)<<"3.ALCOHOL"<<setw(26)<<"0.Exit"<<endl;
            ...
            switch(op){
                ...
                case 2:
                   cout<<"\t\t\t\t===========================>> JUICE <<============================="<<endl;
                    ...
                    cout<<"\t\t\t\t\tOrder by :"<<order<<endl;
                    cout<<"\t\t\t\t\tQuantity :"<<qty<<endl;
                    cout<<"\t\t\t\t\tSeat Not :"<<seat<<endl;
                    cout<<"\t\t\t\t\tTotal Payment_USD :"<<payment_USD<<" $ "<<endl;
                    cout<<"\t\t\t\t\tTotal Payment_USD :"<<payment_KHR<<" R "<<endl<<endl;
                    cout<<"\t\t\t\t-------------------------->> Thank you <<------------------------------"<<endl;
                break;
                case 3:
                    cout<<"\t\t\t\t============================>> SHAKE <<============================="<<endl;
                    ...
                    cout<<"\t\t\t\t\tPayment KHR : R"<<payment_KHR<<endl<<endl;
                    cout<<"\t\t\t\t-------------------------->> Thank you <<------------------------------"<<endl;
                break;
            }
        break;
        case 3:
            ...
            switch(op){
                case 1:
                    ...
                    cout<<"\t\t\t\t\tPayment USD :"<<payment_USD<<endl;
                    cout<<"\t\t\t\t\tPayment KHR :"<<payment_KHR<<endl<<endl;
                    cout<<"\t\t\t\t-------------------------->> Thank you <<------------------------------"<<endl;
                break;
                case 2:
                    ...
                    switch(op){
                        case 10:
                            ...
                            switch(op){
                                ...
                                cout<<"\t\t\t\t\tPayment : "<<payment_KHR<<endl<<endl;
                                cout<<"\t\t\t\t-------------------------->> Thank you <<------------------------------"<<endl;
                        break;
                        case 11:
